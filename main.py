...
if __name__ == "__main__":
    ...
    if not simulation:
        ...
        print("Simulation fitness result: " + str(environment.simulate(True, 5, 0, weights=weights, static_delta_t=200, recurrence=recurrence, fitness_id=3, start_x=400, start_y=175, start_angle=40)))
